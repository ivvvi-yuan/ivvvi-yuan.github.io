class Barchart {
    ...
    initVis() {
      ...
      vis.xAxis = d3.axisBottom(vis.xScale)
          .ticks(['United States', 'United Kingdom', 'Pakistan', 'India', 'Australia', 'France', 'Germany', 'Canada'])
          .tickSizeOuter(0);
    ...
    updateVis() {
      ...
      const aggregatedDataMap = d3.rollups(vis.data, v => v.length, d => d.country);
      vis.aggregatedData = Array.from(aggregatedDataMap, ([key, count]) => ({ key, count }));
  
      const orderedKeys = ['United States', 'United Kingdom', 'Pakistan', 'India', 'Australia', 'France', 'Germany', 'Canada'];
