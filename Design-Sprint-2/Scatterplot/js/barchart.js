class Barchart {
    ...
    initVis() {
      ...
      vis.xAxis = d3.axisBottom(vis.xScale)
          .ticks(['Free','Student', 'Family', 'Premium'])
          .tickSizeOuter(0);
    ...
    updateVis() {
      ...
      const aggregatedDataMap = d3.rollups(vis.data, v => v.length, d => d.subscription_type);
      vis.aggregatedData = Array.from(aggregatedDataMap, ([key, count]) => ({ key, count }));
  
      const orderedKeys = ['Free','Student', 'Family', 'Premium'];
